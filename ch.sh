...
${read}[${white}•${read}] ${green} By.Kz.tutorial
...
$red[Author]     ${cyan} :[Kz.tutorial]] 
$red[Messenger]  ${cyan} :[Bengkel Akun]
$red[Email]      ${cyan} :[Juliopangkey@gmail.com]"
printf "${cyan}\nCam${nc}@${cyan}Hacker ${red}$ ${nc}"
read about
